    ...
    <el-dialog title="获取token" :visible.sync="tokenDialogVisible" center :before-close="closeTokenDialog" v-cloak>
      <el-form :model="tokenForm" label-width="80px" ref="tokenForm">
        <el-row>
          <el-col :span="rowspan">
            <el-form-item label="IP：" prop="ip" required>
              <el-input placeholder="ip" v-model="tokenForm.ip" @blur="joinParams">
                <!-- <template slot="prepend">Http://</template> -->
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="rowspan">
            <el-form-item label="端口：" prop="port" required @blur="joinParams">
              <el-input v-model="tokenForm.port" placeholder="port"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="rowspan">
            <el-form-item label="server：" prop="server" required>
              <el-input v-model="tokenForm.server" placeholder="server" @blur="joinParams"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="rowspan">
            <el-form-item label="方式：" prop="method" required>
              <el-select v-model="tokenForm.method" placeholder="请求方式：">
                <el-option label="GET" value="get"></el-option>
                <el-option label="POST" value="post"></el-option>
              </el-select>
            </el-form-item>
        ...
        <el-form-item label="url：" prop="url" required>
          <el-input v-model="tokenForm.url" placeholder="url"></el-input>
        </el-form-item>
        <el-row>
          <el-col :span="rowspan">
            <el-form-item label="用户名：" prop="user" required>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="tokenDialogVisible = false;resetForm('tokenForm')">取 消</el-button>
  ...
  export default{
    data(){
      return {
        ...
        cpRestData: [
          { id: '1', name: '获取登录token', link: 'http://192.168.32.46:7071/aplanmis-rest/province/authentication?user=htry&password=123' },
          { id: '2', name: '详情首页', link: 'http://192.168.32.46:8084/aplanmis-mall/swagger-ui.html#/' },
          { id: '3', name: '蓝湖', link: 'https://lanhuapp.com/web/#/item/project/board?pid=74e64e67-c4b7-49e9-a9c3-b36883819ed5&teamId=016f447a-f40d-4c2b-8264-99e43e3cc9de' },
        ...
        giteeData: [
          {
            id: 1, name: '4.0：planmis-project', link: 'https://gitee.com/fasterstrong_admin/aplanmis-project', desc: '4.0首页',
            children: [
              { id: 11, name: '4.0：issues', desc: '4.0 bug', link: 'https://gitee.com/fasterstrong_admin/aplanmis-project/issues' },
              { id: 12, name: '4.0：tags', link: 'https://gitee.com/fasterstrong_admin/aplanmis-project/tags', desc: '4.0 标签' },
              { id: 13, name: '4.0：branches', link: 'https://gitee.com/fasterstrong_admin/aplanmis-project/branches', desc: '4.0 分支' }
            ]
          },
          {
            id: 2, name: '3.0：construction-project', link: 'https://gitee.com/fasterstrong/construction-project', desc: '3.0首页',
            children: [
              { id: 21, name: '3.0 tags', link: 'https://gitee.com/fasterstrong/construction-project/tags', desc: '3.0标签' },
              { id: 22, name: '3.0 branches', link: 'https://gitee.com/fasterstrong/construction-project/branches', desc: '3.0 分支' }
            ]
          }
        ],
        url: '',
        tokenForm: {
          ip: '192.168.32.46', port: '7071', server: 'aplanmis-rest', method: 'get',
          user: 'htry', password: '123', result: '', token: '', headers: '', url: '',

        },
        urlParam: {
          ip: '192.168.32.46', port: '8083', server: 'aplanmis-front', method: 'get', mapping: 'aea/item/basic/listLatestAeaItemBasicTreeByPage.do', url: ''
        },
        requestParam: {
    ...
    methods: {
      ...
      joinParams: function () {
        var _this = this;
        var url = 'http://' + _this.tokenForm.ip + ':' + _this.tokenForm.port + '/'
            + _this.tokenForm.server + '/province/authentication';
        _this.tokenForm.url = url;
      },
      joinUrlParams: function () {
        var _this = this;
        var url = 'http://' + _this.urlParam.ip + ':' + _this.urlParam.port + '/'
      ...
      getToken: function () {
        ...
        var url = 'http://' + _this.tokenForm.ip + ':' + _this.tokenForm.port + '/'
            + _this.tokenForm.server + '/province/authentication'
        // + '?user=' + _this.tokenForm.user + '&password=' + _this.tokenForm.password;
        _this.axios({
      ...
      //   };
      //   var obj = {
      //     user: 'htry', password: '123', result: '', token: '', method: 'get',
      //     ip: '192.168.32.46', port: '7071', server: 'aplanmis-rest'
      //   };
      //   var result = this.parseParam(obj);
      //   console.log(result)
      // }
    }
  }
